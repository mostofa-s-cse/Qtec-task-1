                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Organizations Update</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="exampleInputFile" name="name" value="{{$organizations->name}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">Description</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="exampleInputFile" name="description" value="{{$organizations->description}}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
