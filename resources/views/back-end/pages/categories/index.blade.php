...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{route("categories.create")}}" class="btn btn-primary mb-2" style="float:right;">Add Category</a>
                </div>
                <div class="col-12">
                    <div class="card">
    ...
    <script>
        var datatable = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'organization_name', name: 'organization_name', orderable: true,},
